...
@JsModule("./themes/HybridMenu/NotificationCenter.js")
public class NotificationCenter extends VerticalLayout {
	...
	public NotificationCenter() {
		...
		addFooter(HMButton.get()
						  .withIcon(VaadinIcon.ANGLE_RIGHT.create())
						  .withStyleName(Styles.buttonIconOnly)
						  .withThemeName("ncButton")
